  ...
  return (
    <div className="min-h-screen bg-amber-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="absolute top-8 right-16 md:top-12 md:right-20 w-32 h-32 md:w-40 md:h-40 border-2 border-black rounded-full flex items-center justify-center z-10">
          <div className="w-8 h-8 md:w-12 md:h-12 bg-black rounded-full ml-2 md:ml-3"></div>
        </div>
        
        {/* Rotated square - bottom left - moved 15px right and 20px up (towards center) */}
        <div className="absolute bottom-24 left-20 md:bottom-28 md:left-24 w-28 h-28 md:w-36 md:h-36 border-2 border-black transform rotate-45 z-10"></div>
